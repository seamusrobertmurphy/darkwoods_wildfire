...
#install.packages(c("readxl", "sf", "kernlab", "ggplot2", "dplyr", "RColorBrewer", "psych", "useful", "caret", "tibble", "klaR", "ModelMetrics", "DescTools", "MLmetrics", "knitr", "kableExtra"), dependencies=TRUE)
library(readxl)
library(sf)
library(kernlab)
library(ggplot2)
...
Compare performance of `svmLinear` model between training, test, and full dataset, using absolute and relative MAE, RMSE, and RMSE-ratio metrics, and `TheilU` statistic of model bias. Results table below taken from manuscript section 2.3. Updates pending.
